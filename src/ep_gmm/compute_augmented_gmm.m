function [ V_xa, V_xb, m_xa, m_xb, p ] = compute_augmented_gmm( ...
  gmm, ...        % Gauss. Mixture Model params
  v_inv_divi, ... % Cavity inverse variance
  m_divi, ...     % Cavity mean
  y_i ...         % Data for this factor
  )
% COMPUTE_AUGMENTED_GMM - Updates the augmented distribution for an iid
%   two-component Gaussian mixture model.  Returns the mean/variance and
%   mixture weights of the GMM.
%
% THROWS:
