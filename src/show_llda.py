...
files = ('corpus_SPARSEBARS_alg_llda_gibbs_sel_random_numinit_150_trainsteps_100_Nsamp_1000_DISCVAR_runid_5.mat',
         'corpus_SPARSEBARS_alg_llda_gibbs_sel_gibbs_numinit_150_trainsteps_100_Nsamp_1000_DISCVAR_runid_5.mat',
         'corpus_SPARSEBARS_alg_llda_ep_sel_discvar_numinit_150_trainsteps_100_Nsamp_100_DEBUG_DISCVAR_SMALLSAMP_runid_5.mat',)
names = ('Random','Gibbs','Variational',)
colors = ('-g','-b','-k',)
